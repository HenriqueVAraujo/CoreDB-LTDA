    ...
    <div className="bg-[#0B1C2D] min-h-screen text-white font-sans selection:bg-[#1DAEFF]/30">
      ...
      <header className="py-20 bg-gradient-to-b from-[#0B1C2D] to-[#0f273d]">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-[#1DAEFF] font-medium mb-2">CoreDB — O núcleo da continuidade.</p>
          <p className="text-white/40 text-sm">Última atualização: 13 de setembro de 2026</p>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <article className="prose prose-invert prose-blue max-w-none space-y-12 text-white/80 leading-relaxed">
            <section>
              ...
              <p>A CoreDB LTDA é uma empresa <strong>independente</strong> de engenharia e execução de tecnologia crítica. Não somos afiliados, representantes ou parceiros oficiais da TOTVS® S.A. Lidamos com dados críticos B2B com foco em performance e segurança.</p>
            </section>
